    ...
    const cards = [
        {
            // Картка екземпляру
            id: 1,
            img: "/avatar-default.png", // Шлях до зображення
            name: "John D",             // Ім'я картки
            info: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque sed mi sit amet magna posuere finibus. Suspendisse nibh augue, commodo in" // Інформація про картку
                + " \u25AA Location: _____. \u25AA Number: _____. \u25AA Email: _____. " // Контактна інформація
            ...
            <main style={styles.cardList}>
                {cards.map((card) => (
                    <div
                        ...
                        style={{
                            ...styles.card,
                            ...(selectedCard?.id === card.id ? styles.selectedCard : {}), // Динамічне виділення вибраної картки
                        }}
